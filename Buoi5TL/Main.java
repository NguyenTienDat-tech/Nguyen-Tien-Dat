...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Cage case1 = new Cage("1234", makePets);
        Cage case2 = new Cage("6789", makePets);
        ...
        while (check.equalsIgnoreCase("Y")){
            ...
            if (userChoose == 1){
                ...
                if (currentPet + case1.getCurrentPetCount() > Cage.MAX_CAPACITY){
                ...
                System.out.println("Bạn muốn thêm bao nhiêu thú cưng ?");
                int currentPet = Integer.parseInt(sc.nextLine());
                if (currentPet + case2.getCurrentPetCount() > Cage.MAX_CAPACITY){
                    System.out.println("Quá số thú tối đa rồi !");
                }
                else{
                    for (int i = 1; i <= currentPet; i++){
        ...
        System.out.println("Số lồng đã tạo là: " + Cage.totalCages);
